...
const Sidebar = ({ setAuth }) => {
  ...
  return (
    <div className="p-4 sticky top-0 bg-[#f0f5fa] h-screen">
      ...
      <div>
        <button
          className="flex items-center md:justify-start justify-center gap-2 w-full rounded px-2 py-1.5 cursor-pointer text-sm hover:bg-[#e0ecfd] text-[#696969] shadow-none "
          onClick={(e) => logout(e)}
        >
